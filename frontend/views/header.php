                ...
                <div class="width1024">
                    <ul class="desktop-element">
                        <li><?=!empty($currentUser ['login']) 
                            ...
                            : '<a href="?model=register&action=form">Register</a>'?></li>
                        <li><?=!empty($currentUser ['login']) 
                            ? '<a href="?model=auth&action=logout">Sing out</a>'
                            : '<a href="?model=site&action=login">Sing in</a>'?></li>
                    ...
                    <select id="top-link" onchange="document.location=this.value" class="mobile-element form-control">
                        ...
                        <option value="?model=site&action=login">Sing in</option>
